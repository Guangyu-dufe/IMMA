...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dataset", type=str, 
                        default="SD", help="Which dataset to run")
    ...
    elif DATASET_NAME in ("SD"):
        param_dict["data_file_path"] = os.path.join("/home/bd2/ANATS/Offline_Baselines/data/", DATASET_NAME, f"2017.npz")
        param_dict["train_ratio"] = 0.6
        param_dict["valid_ratio"] = 0.2
        param_dict["steps_per_day"] = 288
