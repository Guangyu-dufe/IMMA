...
def train(inputs, args):
    ...
    best_model.basic_model.get_embeddings(args.sub_adj.shape[0])
    best_model.basic_model_m.get_embeddings(args.sub_adj.shape[0])
...
def test_model(model, args, testset, pin_memory):
    ...
    with torch.no_grad():
        ...
        np.savez(osp.join(args.save_data_path, f'test_results_{args.year}.npz'), pred=pred_, truth=truth_)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--first_year_model_path", type = str, default = "/home/bd2/ANATS/TrafficStream/res/CA/ca2025-06-08-03:40:41.360742/2017/24.9058.pkl", help='specify a pretrained model root')
    args = parser.parse_args()
    # /home/bd2/ANATS/TrafficStream/res/SD/wo_moco2025-05-26-12:22:42.735211/2017/27.1851.pkl
    init(args)
    seed_set(13)
