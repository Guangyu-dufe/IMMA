...
sys.path.append("src/")
import setproctitle
# setproctitle.setproctitle("IMPORTANT: DONOT KILL PLS")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_first_year", type = int, default = 1, help="1: training first year, 1: load from model path of first year")
